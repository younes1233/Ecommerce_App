...
import { RiContactsLine, RiStockLine,RiProductHuntLine } from 'react-icons/ri';
...
export const links = [
...

  {
    ...
    links: [
      {
        name: 'products',
        link_name: 'admin/products',
        icon: <RiProductHuntLine />,
      },
      {
        name: 'orders',
        link_name: 'admin/orders',
        icon: <AiOutlineShoppingCart />,
      },
      {
        name: 'employees',
        link_name: 'admin/employees',
        icon: <IoMdContacts />,
      },
      {
        name: 'customers',
        link_name: 'admin/customers',
        icon: <RiContactsLine />,
      },
  ...
  },
  {
    ...
    links: [
      {
        name: 'calendar',
        link_name: 'admin/calender',
        icon: <AiOutlineCalendar />,
      },
      {
        name: 'kanban',
        link_name: 'admin/kanban',
        icon: <BsKanban />,
      },
      {
        name: 'editor',
        link_name: 'admin/editor',
        icon: <FiEdit />,
      },
      {
        name: 'color-picker',
        link_name: 'admin/color-picker',
        icon: <BiColorFill />,
      },
    ],
  },
  {
    ...
    links: [
      {
        name: 'line',
        link_name: 'admin/line',
        icon: <AiOutlineStock />,
      },
      {
        name: 'area',
        link_name: 'admin/area',
